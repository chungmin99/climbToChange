  ...
  render() {
    return (
      <View style={{ flex: 1, alignItems: 'stretch', justifyContent: 'center', backgroundColor: '#90A4AE' }}>
        <ImageBackground source={require('./nature.jpg')} style={{width: '100%', height: '100%'}}>
      <Text style={{ color: 'white', fontSize:32, textAlign: 'center', paddingTop: 200 }}>Our Mission</Text>
      <Text style={{ color: 'white', fontSize:20, textAlign: 'center' }}>Build your knowledge. Change the world. Together, we can stop climate change.</Text>
      <Text style={{ color: 'white', fontSize:32, textAlign: 'center', paddingTop: 100}}>Climate Change Timeline</Text>
  <Slider
